...
If you decide to pitch in and write some code, this document will provide you with useful information: [CONTRIBUTING.md](https://github.com/alygin/vscode-tlaplus/blob/HEAD/CONTRIBUTING.md).
...
[MIT](https://github.com/alygin/vscode-tlaplus/blob/HEAD/LICENSE)
